...
import { canAccessLsaLayer, canCreateAnyNucleus, isClusterCoordinator, isLsaMember, lsaAccessibleClusterIds, type CallerContext } from '../lib/permissions';
        ...
        {!isMobile && <aside
          ...
          <div className="p-6 border-b border-gray-100">
            ...
            <div className="space-y-2">
              ...
              {/* Learning Hub — a cluster-level reflective synthesis space.
                  Only visible to roles that can see the cluster landing
                  page: CC, LSA, regional viewer, admin/super-admin. AL and
                  NC users (who are pinned elsewhere) never see this. The
